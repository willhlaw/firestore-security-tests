...
function getAuthObj(callback) {
  ...
  var resolvedKeyCredentialsPath = _path.default.resolve(thisPath, toTopLevelDirectoryRelativePathStr, keyCredentialsPath);
  ...
  var key = require(resolvedKeyCredentialsPath);
